...
function Lesson6Content({ onBack, onNavigateToLesson }) {
...
function Lesson6({ onBack, onNavigateToLesson }) {
  return (
    <Lesson6Provider>
      <Lesson6Content onBack={onBack} onNavigateToLesson={onNavigateToLesson} />
    </Lesson6Provider>
  )
}

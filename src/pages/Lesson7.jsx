...
function Lesson7Content({ onBack, onNavigateToLesson }) {
...
function Lesson7({ onBack, onNavigateToLesson }) {
  return (
    <Lesson7Provider>
      <Lesson7Content onBack={onBack} onNavigateToLesson={onNavigateToLesson} />
    </Lesson7Provider>
  )
}

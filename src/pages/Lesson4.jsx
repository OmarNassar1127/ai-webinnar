...
import { Play, Wrench, MonitorPlay, Eye, AlertTriangle, HelpCircle, Trophy } from 'lucide-react'
...
import {
  ...
  QuizTime,
  Completion
} from '../sections/lesson4'

import { Lesson4Provider, useLesson4 } from '../context/Lesson4Context'

const sections = [
  { id: 1, title: 'Introduction', icon: Play },
  { id: 2, title: "What We're Building", icon: Wrench },
  { id: 3, title: 'Demo', icon: MonitorPlay },
  { id: 4, title: 'Key Observations', icon: Eye },
  { id: 5, title: 'What to Watch For', icon: AlertTriangle },
...
function Lesson4Content({ onBack, onNavigateToLesson, isNextLessonBlocked }) {
...
function Lesson4({ onBack, onNavigateToLesson, isNextLessonBlocked }) {
  return (
    <Lesson4Provider>
      <Lesson4Content onBack={onBack} onNavigateToLesson={onNavigateToLesson} isNextLessonBlocked={isNextLessonBlocked} />
    </Lesson4Provider>
  )
}

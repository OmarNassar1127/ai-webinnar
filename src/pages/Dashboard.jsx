      ...
      <main className="pt-24 pb-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              From zero to AI pro. Learn to harness the power of artificial intelligence
              to supercharge your productivity and unlock new possibilities. By Omar and his agents.
            </motion.p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-slate-400">
                Omar AI Academy © {new Date().getFullYear()}
              </span>
            </div>

            <div className="flex items-center gap-6">
              <a
                href="https://www.linkedin.com/in/omar-nassar-dev/"
                target="_blank"

...
import { Trophy, MessageSquare, RefreshCw, FileText, Zap, ArrowRight, Home, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 relative overflow-hidden">
      ...
      >
        ...
        <Button variant="primary" size="lg" onClick={() => onNavigateToLesson && onNavigateToLesson(5)}>

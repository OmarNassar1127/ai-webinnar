          ...
          return (
            <motion.button
              ...
              className={`w-full p-4 rounded-xl text-left transition-all duration-300 flex items-start gap-4 ${
                showCorrect
                  ? 'bg-emerald-500/20 border-2 border-emerald-500 animate-bounce'
                  : showWrong
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold mb-2">
          {passed ? (
            <span className="gradient-text">Excellent Work!</span>
          ) : (
        ...
        <p className="text-sm text-slate-500">
          {passed
            ? "You've demonstrated a solid understanding of AI fundamentals!"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gradient-text">Let's Test Your Knowledge!</span>
          </h1>
          <p className="text-xl text-slate-400">
            6 quick questions to check your understanding
          </p>
        </motion.div>

    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold mb-2">
          {passed ? (
            <span className="gradient-text">Software Savvy!</span>
          ) : (
        ...
        <p className="text-sm text-slate-500">
          {passed
            ? "You've mastered the software component basics! You're ready to describe any app like a pro."
            : "Review the restaurant analogy and component roles, then try again!"}
        </p>
      </motion.div>
...
const QuizTime = ({ onComplete }) => {
  const { setQuizAnswer } = useLesson2();
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gradient-text">Test Your Software Knowledge!</span>
          </h1>
          <p className="text-xl text-slate-400">
            6 questions about software components and the restaurant analogy
          </p>
        </motion.div>
        ...
        {!quizComplete ? (
          <>
            ...
            <AnimatePresence mode="wait">
              <QuestionCard
                key={currentQuestion}
                question={quiz2Questions[currentQuestion]}
